 ...
 *
 * @li ASIO_LIBNS::ip::tcp::socket
 * @li ASIO_LIBNS::ip::tcp::acceptor
 * @li ASIO_LIBNS::ip::udp::socket
 * @li ASIO_LIBNS::deadline_timer.
 *
 ...
 *
 * @code
 * ASIO_LIBNS::io_context io_context;
 * ...
 * for (;;)
 * {
 *   try
 ...
 *
 * To submit functions to the io_context, use the @ref ASIO_LIBNS::dispatch,
 * @ref ASIO_LIBNS::post or @ref ASIO_LIBNS::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * ASIO_LIBNS::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * ASIO_LIBNS::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * ASIO_LIBNS::executor_work_guard<io_context::executor_type>:
 *
 * @code ASIO_LIBNS::io_context io_context;
 * ASIO_LIBNS::executor_work_guard<ASIO_LIBNS::io_context::executor_type>
 *   = ASIO_LIBNS::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   * without blocking.
   */
  ASIO_DECL count_type run(ASIO_LIBNS::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  ASIO_DECL count_type run_one(ASIO_LIBNS::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  ASIO_DECL count_type poll(ASIO_LIBNS::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  ASIO_DECL count_type poll_one(ASIO_LIBNS::error_code& ec);
#endif // !defined(ASIO_NO_DEPRECATED)
  ...
  /// (Deprecated: Use ASIO_LIBNS::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use ASIO_LIBNS::post().) Request the io_context to invoke
...
private:
   ...
   *     ASIO_LIBNS::execution::blocking.possibly); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::relationship.fork); @endcode
   */
  ASIO_CONSTEXPR basic_executor_type require(
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::relationship.continuation); @endcode
   */
  ASIO_CONSTEXPR basic_executor_type require(
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::outstanding_work.tracked); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::outstanding_work.untracked); @endcode
   */
  ASIO_CONSTEXPR basic_executor_type<Allocator,
      ASIO_UNSPECIFIED(Bits & ~outstanding_work_tracked)>
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::allocator(my_allocator)); @endcode
   */
   ...
   * @code auto ex1 = my_io_context.get_executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::allocator); @endcode
   */
...
private:
  ...
  friend struct ASIO_LIBNS::execution::detail::mapping_t<0>;
  friend struct ASIO_LIBNS::execution::detail::outstanding_work_t<0>;
#endif // !defined(GENERATING_DOCUMENTATION)
   ...
   * if (ASIO_LIBNS::query(ex, ASIO_LIBNS::execution::mapping)
   *       == ASIO_LIBNS::execution::mapping.thread)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * ASIO_LIBNS::io_context& ctx = ASIO_LIBNS::query(
   *     ex, ASIO_LIBNS::execution::context); @endcode
   */
   ...
   *       == ASIO_LIBNS::execution::blocking.always)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (ASIO_LIBNS::query(ex, ASIO_LIBNS::execution::relationship)
   *       == ASIO_LIBNS::execution::relationship.continuation)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * if (ASIO_LIBNS::query(ex, ASIO_LIBNS::execution::outstanding_work)
   *       == ASIO_LIBNS::execution::outstanding_work.tracked)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_io_context.get_executor();
   * auto alloc = ASIO_LIBNS::query(ex,
   *     ASIO_LIBNS::execution::allocator); @endcode
   */
  template <typename OtherAllocator>
...
public:
   ...
   */
  explicit work(ASIO_LIBNS::io_context& io_context);
  ...
  ASIO_LIBNS::io_context& get_io_context();
...
protected:
   ...
   */
  ASIO_DECL service(ASIO_LIBNS::io_context& owner);
...
class service_base
  : public ASIO_LIBNS::io_context::service
{
public:
  static ASIO_LIBNS::detail::service_id<Type> id;

  // Constructor.
  service_base(ASIO_LIBNS::io_context& io_context)
    : ASIO_LIBNS::io_context::service(io_context)
  {
  }
};

template <typename Type>
ASIO_LIBNS::detail::service_id<Type> service_base<Type>::id;
...
struct equality_comparable<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>
  >
{
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::blocking_t::possibly_t
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::io_context::basic_executor_type<
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::blocking_t::never_t
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::relationship_t::fork_t
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::relationship_t::continuation_t
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::outstanding_work_t::tracked_t
  > : ASIO_LIBNS::detail::io_context_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::io_context::basic_executor_type<
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::outstanding_work_t::untracked_t
  > : ASIO_LIBNS::detail::io_context_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::allocator_t<void>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct require_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::allocator_t<OtherAllocator>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
...
struct query_static_constexpr_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    Property,
    typename ASIO_LIBNS::enable_if<
      ASIO_LIBNS::is_convertible<
        Property,
        ASIO_LIBNS::execution::outstanding_work_t
      >::value
    >::type
  > : ASIO_LIBNS::detail::io_context_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::execution::outstanding_work_t result_type;
...
struct query_static_constexpr_member<
    ...
    typename ASIO_LIBNS::enable_if<
      ASIO_LIBNS::is_convertible<
        Property,
        ASIO_LIBNS::execution::mapping_t
      >::value
    >::type
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::execution::mapping_t::thread_t result_type;
...
struct query_member<
    ...
    typename ASIO_LIBNS::enable_if<
      ASIO_LIBNS::is_convertible<
        Property,
        ASIO_LIBNS::execution::blocking_t
      >::value
    >::type
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::execution::blocking_t result_type;
};
...
struct query_member<
    ...
    typename ASIO_LIBNS::enable_if<
      ASIO_LIBNS::is_convertible<
        Property,
        ASIO_LIBNS::execution::relationship_t
      >::value
    >::type
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::execution::relationship_t result_type;
};

template <typename Allocator, uintptr_t Bits>
struct query_member<
    ASIO_LIBNS::io_context::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::context_t
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::io_context& result_type;
};
