 ...
 * expression <tt>ASIO_LIBNS::prefer(E, P0, Pn...)</tt> for some subexpressions
 ...
 *   <tt>ASIO_LIBNS::prefer(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>ASIO_LIBNS::prefer(ASIO_LIBNS::prefer(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>ASIO_LIBNS::prefer(ASIO_LIBNS::prefer(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>ASIO_LIBNS::prefer(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>ASIO_LIBNS::prefer(std::declval<T>(),
 ...
 * type of the expression <tt>ASIO_LIBNS::prefer(std::declval<T>(),
...
using ASIO_LIBNS::is_applicable_property;
using ASIO_LIBNS::traits::prefer_free;
using ASIO_LIBNS::traits::prefer_member;
using ASIO_LIBNS::traits::require_free;
using ASIO_LIBNS::traits::require_member;
