...
public:
      ...
      >::type* = 0) const
  {
    ...
    execution::execute(
        ASIO_LIBNS::prefer(
          ASIO_LIBNS::require(ex, execution::blocking.never),
      ...
      >::type* = 0) const
  {
    ...
    ex.defer(ASIO_LIBNS::detail::bind_handler(
...
public:
      ...
      >::type* = 0) const
  {
    ...
    execution::execute(
        ASIO_LIBNS::prefer(
          ASIO_LIBNS::require(ex_, execution::blocking.never),
          execution::relationship.continuation,
          execution::allocator(alloc)),
        ASIO_LIBNS::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)));
      ...
      >::type* = 0) const
  {
    ...
    ex_.defer(ASIO_LIBNS::detail::bind_handler(
          ASIO_MOVE_CAST(CompletionHandler)(handler)), alloc);
  }
