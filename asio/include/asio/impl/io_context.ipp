...
{
  ASIO_LIBNS::detail::scoped_ptr<impl_type> scoped_impl(impl);
  ASIO_LIBNS::add_service<impl_type>(*this, scoped_impl.get());
...
io_context::count_type io_context::run(ASIO_LIBNS::error_code& ec)
{
  return impl_.run(ec);
}
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::run_one(ASIO_LIBNS::error_code& ec)
{
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll(ASIO_LIBNS::error_code& ec)
{
...
#if !defined(ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll_one(ASIO_LIBNS::error_code& ec)
{
...
io_context::service::service(ASIO_LIBNS::io_context& owner)
