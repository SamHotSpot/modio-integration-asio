 ...
 * expression <tt>ASIO_LIBNS::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>ASIO_LIBNS::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>ASIO_LIBNS::require(ASIO_LIBNS::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>ASIO_LIBNS::require(ASIO_LIBNS::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>ASIO_LIBNS::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>ASIO_LIBNS::require(std::declval<T>(),
 ...
 * type of the expression <tt>ASIO_LIBNS::require(std::declval<T>(),
