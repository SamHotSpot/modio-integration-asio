...
private:
   ...
   *
   * For example:
   * @code ASIO_LIBNS::system_executor ex1;
...
private:
   ...
   *
   * For example:
   * @code ASIO_LIBNS::system_executor ex;
   ...
   * For example:
   * @code ASIO_LIBNS::system_executor ex;
   * ASIO_LIBNS::system_context& pool = ASIO_LIBNS::query(
...
struct equality_comparable<
    ASIO_LIBNS::basic_system_executor<Blocking, Relationship, Allocator>
  >
{
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::basic_system_executor<
      ASIO_LIBNS::execution::blocking_t::possibly_t,
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::basic_system_executor<Blocking,
      ASIO_LIBNS::execution::relationship_t::fork_t,
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::system_context& result_type;
};
...
struct query_member<
    ASIO_LIBNS::basic_system_executor<Blocking, Relationship, Allocator>,
    ASIO_LIBNS::execution::allocator_t<Allocator>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
