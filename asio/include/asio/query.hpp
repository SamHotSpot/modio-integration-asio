 ...
 * expression <tt>ASIO_LIBNS::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>ASIO_LIBNS::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>ASIO_LIBNS::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>ASIO_LIBNS::query(std::declval<T>(),
 ...
 * type of the expression <tt>ASIO_LIBNS::query(std::declval<T>(),
...
using ASIO_LIBNS::traits::query_free;
using ASIO_LIBNS::traits::query_member;
using ASIO_LIBNS::traits::static_query;
