...
struct has_sender_traits<S,
    typename enable_if<
      is_same<
        typename ASIO_LIBNS::execution::sender_traits<
...
#define ASIO_EXECUTION_SENDER ::ASIO_LIBNS::execution::sender
...
#define ASIO_EXECUTION_SENDER_TO(r) \
  ::ASIO_LIBNS::execution::sender_to<r>
...
#define ASIO_EXECUTION_TYPED_SENDER \
  ::ASIO_LIBNS::execution::typed_sender
