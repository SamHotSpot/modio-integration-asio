...
struct blocking_t
{
  ...
  {
    return ASIO_LIBNS::query(ex, possibly_t());
  }
...
#endif // !defined(__clang__)
  {
    return ASIO_LIBNS::query(ex, always_t());
  }
...
#endif // !defined(__clang__)
  {
    return ASIO_LIBNS::query(ex, never_t());
  }
...
public:
  ...
  {
    return ASIO_LIBNS::query(executor_, p);
  }
  ...
  {
    return ASIO_LIBNS::require(executor_, possibly_t<I>());
  }
  ...
  {
    return ASIO_LIBNS::require(executor_, never_t<I>());
  }
      ...
      is_nothrow_require<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename require_result<const Executor&, Property>::type
        >::type>(0, ASIO_LIBNS::require(executor_, p));
  }
      ...
      is_nothrow_prefer<const Executor&, Property>::value))
  {
    return adapter<typename decay<
      typename prefer_result<const Executor&, Property>::type
        >::type>(0, ASIO_LIBNS::prefer(executor_, p));
  }
