...
struct as_invocable
{
  ...
  explicit as_invocable(Receiver& r) ASIO_NOEXCEPT
    : receiver_(ASIO_LIBNS::detail::addressof(r))
  {
  }
...
{
  Receiver* receiver_;
  ASIO_LIBNS::detail::shared_ptr<ASIO_LIBNS::detail::atomic_count> ref_count_;

  explicit as_invocable(Receiver& r,
      const ASIO_LIBNS::detail::shared_ptr<
        ASIO_LIBNS::detail::atomic_count>& c) ASIO_NOEXCEPT
    : receiver_(ASIO_LIBNS::detail::addressof(r)),
      ref_count_(c)
  {
  }
