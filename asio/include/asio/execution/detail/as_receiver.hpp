...
struct set_value_member<
    ASIO_LIBNS::execution::detail::as_receiver<Function, T>, void()>
{
...
struct set_error_member<
    ASIO_LIBNS::execution::detail::as_receiver<Function, T>, E>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
...
struct set_done_member<
    ASIO_LIBNS::execution::detail::as_receiver<Function, T> >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
