...
template <>
struct set_value_member<ASIO_LIBNS::execution::detail::void_receiver, void()>
{
...
template <typename E>
struct set_error_member<ASIO_LIBNS::execution::detail::void_receiver, E>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
...
template <>
struct set_done_member<ASIO_LIBNS::execution::detail::void_receiver>
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef void result_type;
