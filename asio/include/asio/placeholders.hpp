...
/// as ASIO_LIBNS::basic_stream_socket::async_write_some or
/// ASIO_LIBNS::async_write.
unspecified bytes_transferred;

/// An argument placeholder, for use with boost::bind(), that corresponds to
/// the iterator argument of a handler for asynchronous functions such as
/// ASIO_LIBNS::async_connect.
unspecified iterator;

/// An argument placeholder, for use with boost::bind(), that corresponds to
/// the results argument of a handler for asynchronous functions such as
/// ASIO_LIBNS::basic_resolver::async_resolve.
unspecified results;
...
/// ASIO_LIBNS::signal_set::async_wait.
...
static boost::arg<1>& error
  = ASIO_LIBNS::placeholders::detail::placeholder<1>::get();
static boost::arg<2>& bytes_transferred
  = ASIO_LIBNS::placeholders::detail::placeholder<2>::get();
