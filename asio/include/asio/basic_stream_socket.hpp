...
public:
   ...
   * @code
   * socket.send(ASIO_LIBNS::buffer(data, size));
   * @endcode
  ...
  std::size_t send(const ConstBufferSequence& buffers)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "send");
    return s;
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(ASIO_LIBNS::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(ASIO_LIBNS::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(ASIO_LIBNS::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   *
   * @throws ASIO_LIBNS::system_error Thrown on failure. An error code of
   * ASIO_LIBNS::error::eof indicates that the connection was closed by the
   * peer.
   *
   ...
   * follows:
   * @code
   * socket.receive(ASIO_LIBNS::buffer(data, size));
   * @endcode
  ...
  std::size_t receive(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->impl_.get_service().receive(
        this->impl_.get_implementation(), buffers, 0, ec);
    ASIO_LIBNS::detail::throw_error(ec, "receive");
    return s;
  }
   ...
   * follows:
   * @code
   * socket.receive(ASIO_LIBNS::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(ASIO_LIBNS::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(ASIO_LIBNS::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.write_some(ASIO_LIBNS::buffer(data, size));
   * @endcode
  ...
  std::size_t write_some(const ConstBufferSequence& buffers)
  {
    ...
    std::size_t s = this->impl_.get_service().send(
        this->impl_.get_implementation(), buffers, 0, ec);
    ASIO_LIBNS::detail::throw_error(ec, "write_some");
    return s;
  }
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(ASIO_LIBNS::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.read_some(ASIO_LIBNS::buffer(data, size));
   * @endcode
  ...
  std::size_t read_some(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->impl_.get_service().receive(
        this->impl_.get_implementation(), buffers, 0, ec);
    ASIO_LIBNS::detail::throw_error(ec, "read_some");
    return s;
  }
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(ASIO_LIBNS::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
