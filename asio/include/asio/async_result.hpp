...
#define ASIO_COMPLETION_SIGNATURE \
  ::ASIO_LIBNS::completion_signature
...
#define ASIO_COMPLETION_HANDLER_FOR(sig) \
  ::ASIO_LIBNS::completion_handler_for<sig>
#define ASIO_COMPLETION_HANDLER_FOR2(sig0, sig1) \
  ::ASIO_LIBNS::completion_handler_for<sig0, sig1>
#define ASIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) \
  ::ASIO_LIBNS::completion_handler_for<sig0, sig1, sig2>
...
# define ASIO_COMPLETION_SIGNATURES_TSIMPLEARGS \
    typename ASIO_LIBNS::detail::simple_completion_signature< \
      Signatures>::type...
...
# define ASIO_COMPLETION_SIGNATURES_TSIMPLEARGS \
    typename ::ASIO_LIBNS::detail::simple_completion_signature<Sig0>::type, \
    typename ::ASIO_LIBNS::detail::simple_completion_signature<Sig1>::type, \
    typename ::ASIO_LIBNS::detail::simple_completion_signature<Sig2>::type
...
struct async_completion
{
  ...
  typedef typename ASIO_LIBNS::async_result<
...
# define ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::ASIO_LIBNS::detail::async_result_helper< \
    ct, sig>::return_type
# define ASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::ASIO_LIBNS::detail::async_result_helper< \
...
#else
# define ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::ASIO_LIBNS::async_result< \
    typename ::ASIO_LIBNS::decay<ct>::type, sig>::return_type
# define ASIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::ASIO_LIBNS::async_result< \
    typename ::ASIO_LIBNS::decay<ct>::type, sig0, sig1>::return_type
# define ASIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  typename ::ASIO_LIBNS::async_result< \
    typename ::ASIO_LIBNS::decay<ct>::type, sig0, sig1, sig2>::return_type
#define ASIO_HANDLER_TYPE(ct, sig) \
  typename ::ASIO_LIBNS::async_result< \
    typename ::ASIO_LIBNS::decay<ct>::type, sig>::completion_handler_type
#define ASIO_HANDLER_TYPE2(ct, sig0, sig1) \
  typename ::ASIO_LIBNS::async_result< \
    typename ::ASIO_LIBNS::decay<ct>::type, \
...
#define ASIO_COMPLETION_TOKEN_FOR(sig) \
  ::ASIO_LIBNS::completion_token_for<sig>
#define ASIO_COMPLETION_TOKEN_FOR2(sig0, sig1) \
  ::ASIO_LIBNS::completion_token_for<sig0, sig1>
#define ASIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) \
  ::ASIO_LIBNS::completion_token_for<sig0, sig1, sig2>
...
#define ASIO_ASYNC_OPERATION(t) \
  ::ASIO_LIBNS::async_operation<t>
#define ASIO_ASYNC_OPERATION1(t, a0) \
  ::ASIO_LIBNS::async_operation<t, a0>
#define ASIO_ASYNC_OPERATION2(t, a0, a1) \
  ::ASIO_LIBNS::async_operation<t, a0, a1>
#define ASIO_ASYNC_OPERATION3(t, a0, a1, a2) \
  ::ASIO_LIBNS::async_operation<t, a0, a1, a2>
...
#define ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(e) \
  = typename ::ASIO_LIBNS::default_completion_token<e>::type
