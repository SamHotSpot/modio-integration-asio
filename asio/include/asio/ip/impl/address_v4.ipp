...
address_v4::address_v4(address_v4::uint_type addr)
{
  ...
  addr_.s_addr = ASIO_LIBNS::detail::socket_ops::host_to_network_long(
      static_cast<ASIO_LIBNS::detail::u_long_type>(addr));
}
...
{
  return ASIO_LIBNS::detail::socket_ops::network_to_host_long(addr_.s_addr);
}
...
std::string address_v4::to_string() const
{
  ...
  char addr_str[ASIO_LIBNS::detail::max_addr_v4_str_len];
  const char* addr =
    ASIO_LIBNS::detail::socket_ops::inet_ntop(
        ASIO_OS_DEF(AF_INET), &addr_, addr_str,
        ASIO_LIBNS::detail::max_addr_v4_str_len, 0, ec);
  if (addr == 0)
...
#if !defined(ASIO_NO_DEPRECATED)
std::string address_v4::to_string(ASIO_LIBNS::error_code& ec) const
{
  char addr_str[ASIO_LIBNS::detail::max_addr_v4_str_len];
  const char* addr =
    ASIO_LIBNS::detail::socket_ops::inet_ntop(
    ...
    ASIO_LIBNS::error_code& ec) ASIO_NOEXCEPT
{
  ...
  if (ASIO_LIBNS::detail::socket_ops::inet_pton(
