...
/**
 * The ASIO_LIBNS::ip::address_v4 class provides the ability to use and
...
#else
  typedef ASIO_LIBNS::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  ASIO_LIBNS::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates ASIO_LIBNS::ip::address_v4
 */
...
template <>
struct hash<ASIO_LIBNS::ip::address_v4>
{
  std::size_t operator()(const ASIO_LIBNS::ip::address_v4& addr)
    const ASIO_NOEXCEPT
  {
