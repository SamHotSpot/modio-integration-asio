...
/**
 * The ASIO_LIBNS::ip::address_v6 class provides the ability to use and
...
#else
  typedef ASIO_LIBNS::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  ASIO_LIBNS::detail::in6_addr_type addr_;
 ...
 *
 * @relates ASIO_LIBNS::ip::address_v6
 */
...
template <>
struct hash<ASIO_LIBNS::ip::address_v6>
{
  std::size_t operator()(const ASIO_LIBNS::ip::address_v6& addr)
    const ASIO_NOEXCEPT
  {
    const ASIO_LIBNS::ip::address_v6::bytes_type bytes = addr.to_bytes();
