...
/**
 * The ASIO_LIBNS::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const ASIO_LIBNS::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  ASIO_LIBNS::detail::addrinfo_type hints_;
