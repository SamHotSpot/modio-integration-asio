 ...
 * @code
 * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
 * ASIO_LIBNS::ip::tcp::endpoint endpoint(ASIO_LIBNS::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(ASIO_LIBNS::ip::tcp::acceptor::reuse_address(true));
...
public:
    ...
    : impl_(0, ex)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "listen");
  }
   ...
   * @code
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * acceptor.open(ASIO_LIBNS::ip::tcp::v4());
   * @endcode
   */
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ASIO_LIBNS::error_code ec;
   * acceptor.open(ASIO_LIBNS::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  ASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_acceptor, ASIO_LIBNS::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_acceptor, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @code
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ASIO_LIBNS::ip::tcp::endpoint endpoint(ASIO_LIBNS::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * acceptor.listen(ASIO_LIBNS::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  ASIO_SYNC_OP_VOID listen(int backlog, ASIO_LIBNS::error_code& ec)
  {
    impl_.get_service().listen(impl_.get_implementation(), backlog, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the ASIO_LIBNS::error::operation_aborted error. Ownership of the
   ...
   * ASIO_LIBNS::socket_base::reuse_address
   * ASIO_LIBNS::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::acceptor::reuse_address option(true);
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::acceptor::reuse_address option;
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with ASIO_LIBNS::error::would_block if they are unable to perform the
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * ASIO_LIBNS::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * acceptor.wait(ASIO_LIBNS::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * acceptor.wait(ASIO_LIBNS::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     ASIO_LIBNS::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   *
      ...
      >::type = 0)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "accept");
  }
  ...
  ASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1, Executor1>& peer, ASIO_LIBNS::error_code& ec,
      typename constraint<
        is_convertible<Protocol, Protocol1>::value
      >::type = 0)
  {
   ...
   * @par Example
   * @code
   * void accept_handler(const ASIO_LIBNS::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  async_accept(basic_socket<Protocol1, Executor1>& peer,
      ...
      >::type = 0)
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<AcceptToken, void (ASIO_LIBNS::error_code)>(
          declval<initiate_async_accept>(), token,
          &peer, static_cast<endpoint_type*>(0))))
  {
    return async_initiate<AcceptToken, void (ASIO_LIBNS::error_code)>(
  ...
  ASIO_SYNC_OP_VOID accept(basic_socket<protocol_type, Executor1>& peer,
      endpoint_type& peer_endpoint, ASIO_LIBNS::error_code& ec)
  {
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(ASIO_LIBNS::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(), peer, 0, ec);
   ...
   * @code void handler(
   *   // Result of operation.
   *   const ASIO_LIBNS::error_code& error,
   *
   ...
   *
   * @par Completion Signature
   * @code void(ASIO_LIBNS::error_code,
   *    typename Protocol::socket::template
  ...
  async_accept(
    ...
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<MoveAcceptToken,
        void (ASIO_LIBNS::error_code, typename Protocol::socket::template
          rebind_executor<executor_type>::other)>(
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const Executor1& ex, ASIO_LIBNS::error_code& ec,
      typename constraint<
        is_executor<Executor1>::value
          || execution::is_executor<Executor1>::value
      >::type = 0)
  ...
  typename Protocol::socket::template rebind_executor<
      typename ExecutionContext::executor_type>::other
  accept(ExecutionContext& context, ASIO_LIBNS::error_code& ec,
      typename constraint<
        is_convertible<ExecutionContext&, execution_context&>::value
      >::type = 0)
  {
   ...
   * ...
   * ASIO_LIBNS::ip::tcp::endpoint endpoint;
   * ASIO_LIBNS::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
   ...
   * ...
   * ASIO_LIBNS::ip::tcp::endpoint endpoint;
   * ASIO_LIBNS::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(endpoint_type& peer_endpoint, ASIO_LIBNS::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(),
   ...
   * ...
   * ASIO_LIBNS::ip::tcp::endpoint endpoint;
   * ASIO_LIBNS::ip::tcp::socket socket(
