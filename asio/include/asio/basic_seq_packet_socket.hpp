...
public:
   ...
   * follows:
   * @code
   * socket.receive(ASIO_LIBNS::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(ASIO_LIBNS::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(ASIO_LIBNS::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
