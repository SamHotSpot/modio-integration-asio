...
{
public:
  reactive_socket_accept_op_base(const ASIO_LIBNS::error_code& success_ec,
...
public:
  ...
  reactive_socket_accept_op(const ASIO_LIBNS::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
public:
  ...
  reactive_socket_move_accept_op(const ASIO_LIBNS::error_code& success_ec,
