...
{
public:
  io_uring_socket_sendto_op_base(const ASIO_LIBNS::error_code& success_ec,
...
private:
  ...
  buffer_sequence_adapter<ASIO_LIBNS::const_buffer, ConstBufferSequence> bufs_;
  msghdr msghdr_;
};
...
public:
  ...
  io_uring_socket_sendto_op(const ASIO_LIBNS::error_code& success_ec,
