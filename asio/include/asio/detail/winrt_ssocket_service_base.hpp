...
public:
  ...
  ASIO_LIBNS::error_code cancel(base_implementation_type&,
  ...
  ASIO_LIBNS::error_code io_control(base_implementation_type&,
  ...
  ASIO_LIBNS::error_code non_blocking(base_implementation_type&,
  ...
  ASIO_LIBNS::error_code native_non_blocking(base_implementation_type&,
      bool, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
...
protected:
  ...
  ASIO_DECL ASIO_LIBNS::error_code do_set_option(
  ...
  ASIO_DECL ASIO_LIBNS::error_code do_connect(
      base_implementation_type& impl,
  ...
  ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const ASIO_LIBNS::const_buffer& data,
      socket_base::message_flags flags, ASIO_LIBNS::error_code& ec);
  ...
  ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const ASIO_LIBNS::mutable_buffer& data,
      socket_base::message_flags flags, ASIO_LIBNS::error_code& ec);
