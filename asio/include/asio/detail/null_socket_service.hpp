...
public:
  ...
  ASIO_LIBNS::error_code open(implementation_type&,
      const protocol_type&, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_LIBNS::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  ASIO_LIBNS::error_code close(implementation_type&,
  ...
  ASIO_LIBNS::error_code cancel(implementation_type&,
      ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  ...
  ASIO_LIBNS::error_code listen(implementation_type&,
      int, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  ASIO_LIBNS::error_code io_control(implementation_type&,
      IO_Control_Command&, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  ASIO_LIBNS::error_code non_blocking(implementation_type&,
      bool, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  ASIO_LIBNS::error_code native_non_blocking(implementation_type&,
      bool, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  ...
  ASIO_LIBNS::error_code shutdown(implementation_type&,
      socket_base::shutdown_type, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  ASIO_LIBNS::error_code bind(implementation_type&,
  ...
  ASIO_LIBNS::error_code set_option(implementation_type&,
      const Option&, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  ASIO_LIBNS::error_code get_option(const implementation_type&,
      Option&, ASIO_LIBNS::error_code& ec) const
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  std::size_t send(implementation_type&, const ConstBufferSequence&,
      socket_base::message_flags, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return 0;
  }
      ...
      socket_base::message_flags, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    ASIO_LIBNS::post(io_ex, detail::bind_handler(
  ...
  ASIO_LIBNS::error_code accept(implementation_type&,
      Socket&, endpoint_type*, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
  }
  ...
  {
    ASIO_LIBNS::error_code ec = ASIO_LIBNS::error::operation_not_supported;
    ASIO_LIBNS::post(io_ex, detail::bind_handler(handler, ec));
  }

  // Connect the socket to the specified endpoint.
  ASIO_LIBNS::error_code connect(implementation_type&,
      const endpoint_type&, ASIO_LIBNS::error_code& ec)
  {
    ec = ASIO_LIBNS::error::operation_not_supported;
    return ec;
