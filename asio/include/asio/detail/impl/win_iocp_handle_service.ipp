...
{
public:
  explicit overlapped_wrapper(ASIO_LIBNS::error_code& ec)
  {
    Internal = 0;
    InternalHigh = 0;
    Offset = 0;
...
win_iocp_handle_service::win_iocp_handle_service(execution_context& context)
  : execution_context_service_base<win_iocp_handle_service>(context),
    iocp_service_(ASIO_LIBNS::use_service<win_iocp_io_context>(context)),
    mutex_(),
    impl_list_(0)
{
}
...
ASIO_LIBNS::error_code win_iocp_handle_service::assign(
    win_iocp_handle_service::implementation_type& impl,
...
ASIO_LIBNS::error_code win_iocp_handle_service::close(
    win_iocp_handle_service::implementation_type& impl,
...
ASIO_LIBNS::error_code win_iocp_handle_service::cancel(
    win_iocp_handle_service::implementation_type& impl,
    ASIO_LIBNS::error_code& ec)
{
  if (!is_open(impl))
...
size_t win_iocp_handle_service::do_write(
    ...
    const ASIO_LIBNS::const_buffer& buffer, ASIO_LIBNS::error_code& ec)
{
  if (!is_open(impl))
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
void win_iocp_handle_service::start_write_op(
    win_iocp_handle_service::implementation_type& impl, uint64_t offset,
    const ASIO_LIBNS::const_buffer& buffer, operation* op)
{
...
size_t win_iocp_handle_service::do_read(
    win_iocp_handle_service::implementation_type& impl, uint64_t offset,
    const ASIO_LIBNS::mutable_buffer& buffer, ASIO_LIBNS::error_code& ec)
{
  if (!is_open(impl))
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
void win_iocp_handle_service::start_read_op(
    win_iocp_handle_service::implementation_type& impl, uint64_t offset,
    const ASIO_LIBNS::mutable_buffer& buffer, operation* op)
{
  update_cancellation_thread_id(impl);
  iocp_service_.work_started();
