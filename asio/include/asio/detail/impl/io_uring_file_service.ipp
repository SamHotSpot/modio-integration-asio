...
ASIO_LIBNS::error_code io_uring_file_service::open(
...
ASIO_LIBNS::error_code io_uring_file_service::resize(
    io_uring_file_service::implementation_type& impl,
...
ASIO_LIBNS::error_code io_uring_file_service::sync_all(
    io_uring_file_service::implementation_type& impl,
    ASIO_LIBNS::error_code& ec)
{
...
ASIO_LIBNS::error_code io_uring_file_service::sync_data(
    io_uring_file_service::implementation_type& impl,
    ASIO_LIBNS::error_code& ec)
{
