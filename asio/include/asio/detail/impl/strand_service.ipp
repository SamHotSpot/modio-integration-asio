...
strand_service::strand_service(ASIO_LIBNS::io_context& io_context)
  : ASIO_LIBNS::detail::service_base<strand_service>(io_context),
    io_context_(io_context),
    io_context_impl_(ASIO_LIBNS::use_service<io_context_impl>(io_context)),
    mutex_(),
    salt_(0)
{
}
...
void strand_service::do_dispatch(implementation_type& impl, operation* op)
{
  ...
  if (can_dispatch && !impl->locked_)
  {
    ...
    op->complete(&io_context_impl_, ASIO_LIBNS::error_code(), 0);
    return;
  }
