...
epoll_reactor::epoll_reactor(ASIO_LIBNS::execution_context& ctx)
  ...
  if (fork_ev == ASIO_LIBNS::execution_context::fork_child)
  {
        ...
        state != 0; state = state->next_)
    {
      ...
      if (result != 0)
      {
        ...
        ASIO_LIBNS::detail::throw_error(ec, "epoll re-registration");
      }
    }
  }
}
...
int epoll_reactor::do_epoll_create()
{
  ...
  if (fd == -1)
  {
    ASIO_LIBNS::error_code ec(errno,
        ASIO_LIBNS::error::get_system_category());
    ASIO_LIBNS::detail::throw_error(ec, "epoll");
  }
