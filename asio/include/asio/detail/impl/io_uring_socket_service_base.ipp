...
ASIO_LIBNS::error_code io_uring_socket_service_base::close(
    io_uring_socket_service_base::base_implementation_type& impl,
...
ASIO_LIBNS::error_code io_uring_socket_service_base::cancel(
    io_uring_socket_service_base::base_implementation_type& impl,
    ASIO_LIBNS::error_code& ec)
{
  if (!is_open(impl))
...
ASIO_LIBNS::error_code io_uring_socket_service_base::do_open(
    io_uring_socket_service_base::base_implementation_type& impl,
...
ASIO_LIBNS::error_code io_uring_socket_service_base::do_assign(
