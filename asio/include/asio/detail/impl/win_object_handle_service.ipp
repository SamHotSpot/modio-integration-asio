...
ASIO_LIBNS::error_code win_object_handle_service::assign(
    win_object_handle_service::implementation_type& impl,
...
ASIO_LIBNS::error_code win_object_handle_service::close(
    win_object_handle_service::implementation_type& impl,
...
ASIO_LIBNS::error_code win_object_handle_service::cancel(
    win_object_handle_service::implementation_type& impl,
    ASIO_LIBNS::error_code& ec)
{
  if (is_open(impl))
