...
int open(const char* path, int flags, ASIO_LIBNS::error_code& ec)
{
...
int open(const char* path, int flags,
    unsigned mode, ASIO_LIBNS::error_code& ec)
{
...
int close(int d, state_type& state, ASIO_LIBNS::error_code& ec)
{
  int result = 0;
  if (d != -1)
  {
...
bool set_user_non_blocking(int d, state_type& state,
    bool value, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
...
std::size_t sync_read(int d, state_type state, buf* bufs,
    std::size_t count, bool all_empty, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
std::size_t sync_read1(int d, state_type state, void* data,
    std::size_t size, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
std::size_t sync_read_at(int d, state_type state, uint64_t offset,
    buf* bufs, std::size_t count, bool all_empty, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
std::size_t sync_read_at1(int d, state_type state, uint64_t offset,
    void* data, std::size_t size, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
std::size_t sync_write_at1(int d, state_type state, uint64_t offset,
    const void* data, std::size_t size, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
int fcntl(int d, int cmd, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
int fcntl(int d, int cmd, long arg, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
int poll_read(int d, state_type state, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
int poll_write(int d, state_type state, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
...
int poll_error(int d, state_type state, ASIO_LIBNS::error_code& ec)
{
  if (d == -1)
  {
    ec = ASIO_LIBNS::error::bad_descriptor;
