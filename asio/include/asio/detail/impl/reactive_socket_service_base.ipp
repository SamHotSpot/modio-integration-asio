...
ASIO_LIBNS::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
...
ASIO_LIBNS::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    ASIO_LIBNS::error_code& ec)
{
  if (!is_open(impl))
...
ASIO_LIBNS::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, ASIO_LIBNS::error_code& ec)
{
  if (is_open(impl))
  {
...
ASIO_LIBNS::error_code reactive_socket_service_base::do_assign(
    ...
    reactor_op* op, bool is_continuation, bool peer_is_open)
{
  ...
  {
    op->ec_ = ASIO_LIBNS::error::already_open;
    reactor_.post_immediate_completion(op, is_continuation);
  }
}
