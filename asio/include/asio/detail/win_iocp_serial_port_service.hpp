...
public:
  ...
  ASIO_DECL ASIO_LIBNS::error_code open(implementation_type& impl,
      const std::string& device, ASIO_LIBNS::error_code& ec);

  // Assign a native handle to a serial port implementation.
  ASIO_LIBNS::error_code assign(implementation_type& impl,
      const native_handle_type& handle, ASIO_LIBNS::error_code& ec)
  {
  ...
  // Destroy a serial port implementation.
  ASIO_LIBNS::error_code close(implementation_type& impl,
  ...
  ASIO_LIBNS::error_code cancel(implementation_type& impl,
      ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_LIBNS::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_LIBNS::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, ASIO_LIBNS::error_code& ec) const
  {
  ...
  ASIO_LIBNS::error_code send_break(implementation_type&,
      ASIO_LIBNS::error_code& ec)
  {
  ...
  size_t write_some(implementation_type& impl,
      const ConstBufferSequence& buffers, ASIO_LIBNS::error_code& ec)
  {
  ...
  size_t read_some(implementation_type& impl,
      const MutableBufferSequence& buffers, ASIO_LIBNS::error_code& ec)
  {
...
private:
  ...
  typedef ASIO_LIBNS::error_code (*store_function_type)(
      const void*, ::DCB&, ASIO_LIBNS::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static ASIO_LIBNS::error_code store_option(const void* option,
      ::DCB& storage, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_DECL ASIO_LIBNS::error_code do_set_option(
      ...
      const void* option, ASIO_LIBNS::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef ASIO_LIBNS::error_code (*load_function_type)(
      void*, const ::DCB&, ASIO_LIBNS::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static ASIO_LIBNS::error_code load_option(void* option,
      const ::DCB& storage, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_DECL ASIO_LIBNS::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, ASIO_LIBNS::error_code& ec) const;
