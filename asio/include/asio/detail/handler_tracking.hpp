...
public:
  ...
  public:
    ...
    ASIO_DECL void invocation_begin(const ASIO_LIBNS::error_code& ec);

    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const ASIO_LIBNS::error_code& ec, std::size_t bytes_transferred);

    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const ASIO_LIBNS::error_code& ec, int signal_number);

    // Constructor records that handler is to be invoked with two arguments.
    ASIO_DECL void invocation_begin(
        const ASIO_LIBNS::error_code& ec, const char* arg);
...
# define ASIO_INHERIT_TRACKED_HANDLER \
  : public ASIO_LIBNS::detail::handler_tracking::tracked_handler

# define ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public ASIO_LIBNS::detail::handler_tracking::tracked_handler

# define ASIO_HANDLER_TRACKING_INIT \
  ASIO_LIBNS::detail::handler_tracking::init()

# define ASIO_HANDLER_LOCATION(args) \
  ASIO_LIBNS::detail::handler_tracking::location tracked_location args

# define ASIO_HANDLER_CREATION(args) \
  ASIO_LIBNS::detail::handler_tracking::creation args

# define ASIO_HANDLER_COMPLETION(args) \
  ASIO_LIBNS::detail::handler_tracking::completion tracked_completion args
...
# define ASIO_HANDLER_OPERATION(args) \
  ASIO_LIBNS::detail::handler_tracking::operation args

# define ASIO_HANDLER_REACTOR_REGISTRATION(args) \
  ASIO_LIBNS::detail::handler_tracking::reactor_registration args

# define ASIO_HANDLER_REACTOR_DEREGISTRATION(args) \
  ASIO_LIBNS::detail::handler_tracking::reactor_deregistration args
...
# define ASIO_HANDLER_REACTOR_EVENTS(args) \
  ASIO_LIBNS::detail::handler_tracking::reactor_events args

# define ASIO_HANDLER_REACTOR_OPERATION(args) \
  ASIO_LIBNS::detail::handler_tracking::reactor_operation args
