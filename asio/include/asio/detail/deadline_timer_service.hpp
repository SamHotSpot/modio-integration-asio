...
public:
  ...
  deadline_timer_service(execution_context& context)
    : execution_context_service_base<
      ...
      scheduler_(ASIO_LIBNS::use_service<timer_scheduler>(context))
  {
  ...
  std::size_t cancel(implementation_type& impl, ASIO_LIBNS::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, ASIO_LIBNS::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, ASIO_LIBNS::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, ASIO_LIBNS::error_code& ec)
  {
...
private:
  ...
  void do_wait(const Duration& timeout, ASIO_LIBNS::error_code& ec)
  {
#if defined(ASIO_WINDOWS_RUNTIME)
