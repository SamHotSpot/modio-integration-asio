...
public:
  ...
  // Destroy a socket implementation.
  ASIO_DECL ASIO_LIBNS::error_code close(
      base_implementation_type& impl, ASIO_LIBNS::error_code& ec);
  ...
  ASIO_DECL ASIO_LIBNS::error_code cancel(
      base_implementation_type& impl, ASIO_LIBNS::error_code& ec);
  ...
  ASIO_LIBNS::error_code listen(base_implementation_type& impl,
  ...
  ASIO_LIBNS::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_LIBNS::error_code non_blocking(base_implementation_type& impl,
  ...
  ASIO_LIBNS::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_LIBNS::error_code wait(base_implementation_type& impl,
      socket_base::wait_type w, ASIO_LIBNS::error_code& ec)
  {
    switch (w)
    {
      ...
      socket_base::wait_type w, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    switch (w)
    {
      ...
      case socket_base::wait_error:
        ...
        break;
      default:
        p.p->ec_ = ASIO_LIBNS::error::invalid_argument;
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, ASIO_LIBNS::error_code& ec)
  {
    buffer_sequence_adapter<ASIO_LIBNS::mutable_buffer,
...
protected:
  ...
  ASIO_DECL ASIO_LIBNS::error_code do_open(
      base_implementation_type& impl, int af,
      int type, int protocol, ASIO_LIBNS::error_code& ec);

  // Assign a native socket to a socket implementation.
  ASIO_DECL ASIO_LIBNS::error_code do_assign(
  ...
  const ASIO_LIBNS::error_code success_ec_;
};
