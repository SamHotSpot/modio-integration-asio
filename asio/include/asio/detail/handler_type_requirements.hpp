...
#define ASIO_LEGACY_COMPLETION_HANDLER_CHECK( \
  ...
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::zero_arg_copyable_handler_test( \
          ASIO_LIBNS::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      sizeof( \
        ASIO_LIBNS::detail::argbyv( \
          ASIO_LIBNS::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()(), \
...
#define ASIO_READ_HANDLER_CHECK( \
  ...
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::two_arg_handler_test( \
          ASIO_LIBNS::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const ASIO_LIBNS::error_code*>(0), \
  ...
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      ...
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()( \
            ASIO_LIBNS::detail::lvref<const ASIO_LIBNS::error_code>(), \
            ASIO_LIBNS::detail::lvref<const std::size_t>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::one_arg_handler_test( \
          ASIO_LIBNS::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const ASIO_LIBNS::error_code*>(0))) == 1, \
...
#define ASIO_MOVE_ACCEPT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(ASIO_LIBNS::error_code, socket_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::two_arg_move_handler_test( \
          ASIO_LIBNS::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const ASIO_LIBNS::error_code*>(0), \
  ...
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      ...
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()( \
            ASIO_LIBNS::detail::lvref<const ASIO_LIBNS::error_code>(), \
            ASIO_LIBNS::detail::rvref<socket_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_RANGE_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(ASIO_LIBNS::error_code, endpoint_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::two_arg_handler_test( \
  ...
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      ...
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()( \
            ASIO_LIBNS::detail::lvref<const ASIO_LIBNS::error_code>(), \
            ASIO_LIBNS::detail::lvref<const endpoint_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_ITERATOR_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(ASIO_LIBNS::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::two_arg_handler_test( \
  ...
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      ...
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()( \
            ASIO_LIBNS::detail::lvref<const ASIO_LIBNS::error_code>(), \
            ASIO_LIBNS::detail::lvref<const iter_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_RESOLVE_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(ASIO_LIBNS::error_code, range_type)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::two_arg_handler_test( \
  ...
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      ...
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()( \
            ASIO_LIBNS::detail::lvref<const ASIO_LIBNS::error_code>(), \
            ASIO_LIBNS::detail::lvref<const range_type>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
...
#define ASIO_SIGNAL_HANDLER_CHECK( \
  ...
  \
  typedef ASIO_HANDLER_TYPE(handler_type, \
      void(ASIO_LIBNS::error_code, int)) \
    asio_true_handler_type; \
  \
  ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(ASIO_LIBNS::detail::two_arg_handler_test( \
  ...
  typedef ASIO_LIBNS::detail::handler_type_requirements< \
      ...
      sizeof( \
        ASIO_LIBNS::detail::rorlvref< \
          asio_true_handler_type>()( \
            ASIO_LIBNS::detail::lvref<const ASIO_LIBNS::error_code>(), \
            ASIO_LIBNS::detail::lvref<const int>()), \
        char(0))> ASIO_UNUSED_TYPEDEF
