...
public:
  ...
  ASIO_DECL ASIO_LIBNS::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  ASIO_DECL ASIO_LIBNS::error_code close(implementation_type& impl,
      ASIO_LIBNS::error_code& ec);
  ...
  ASIO_DECL ASIO_LIBNS::error_code cancel(implementation_type& impl,
      ASIO_LIBNS::error_code& ec);

  // Perform an IO control command on the descriptor.
  template <typename IO_Control_Command>
  ASIO_LIBNS::error_code io_control(implementation_type& impl,
  ...
  ASIO_LIBNS::error_code non_blocking(implementation_type& impl,
  ...
  ASIO_LIBNS::error_code native_non_blocking(implementation_type& impl,
      bool mode, ASIO_LIBNS::error_code& ec)
  {
  ...
  ASIO_LIBNS::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, ASIO_LIBNS::error_code& ec)
  {
    switch (w)
    {
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, ASIO_LIBNS::error_code& ec)
  {
  ...
  size_t write_some_at(implementation_type& impl, uint64_t,
      const null_buffers& buffers, ASIO_LIBNS::error_code& ec)
  {
