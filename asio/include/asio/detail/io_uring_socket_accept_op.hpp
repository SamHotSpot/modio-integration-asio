...
{
public:
  io_uring_socket_accept_op_base(const ASIO_LIBNS::error_code& success_ec,
  ...
  static bool do_perform(io_uring_operation* base, bool after_completion)
  {
    ...
    if (o->ec_ && o->ec_ == ASIO_LIBNS::error::would_block)
    {
...
public:
  ...
  io_uring_socket_accept_op(const ASIO_LIBNS::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
public:
  ...
  io_uring_socket_move_accept_op(const ASIO_LIBNS::error_code& success_ec,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      ASIO_LIBNS::error_code, peer_socket_type>
