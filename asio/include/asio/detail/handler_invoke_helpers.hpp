...
{
  using ASIO_LIBNS::asio_handler_invoke;
  ...
  (void)static_cast<ASIO_LIBNS::asio_handler_invoke_is_no_longer_used>(
    asio_handler_invoke(function, ASIO_LIBNS::detail::addressof(context)));
}
