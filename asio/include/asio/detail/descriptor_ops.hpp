...
ASIO_DECL bool non_blocking_read_at(int d, uint64_t offset,
    buf* bufs, std::size_t count, ASIO_LIBNS::error_code& ec,
...
ASIO_DECL int fcntl(int d, int cmd, ASIO_LIBNS::error_code& ec);

ASIO_DECL int fcntl(int d, int cmd,
    long arg, ASIO_LIBNS::error_code& ec);

ASIO_DECL int poll_read(int d,
    state_type state, ASIO_LIBNS::error_code& ec);
