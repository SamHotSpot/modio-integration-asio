...
class strand_service
  : public ASIO_LIBNS::detail::service_base<strand_service>
{
private:
...
public:
  ...
  ASIO_DECL explicit strand_service(ASIO_LIBNS::io_context& io_context);
...
private:
  ...
  ASIO_DECL static void do_complete(void* owner,
      operation* base, const ASIO_LIBNS::error_code& ec,
