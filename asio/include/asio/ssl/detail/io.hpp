...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, ASIO_LIBNS::error_code& ec)
{
  ASIO_LIBNS::error_code io_ec;
  ...
  case engine::want_input_and_retry:
    ...
    {
      core.input_ = ASIO_LIBNS::buffer(core.input_buffer_,
...
class io_op
  : public ASIO_LIBNS::detail::base_from_cancellation_state<Handler>
{
public:
  io_op(Stream& next_layer, stream_core& core,
      const Operation& op, Handler& handler)
    : ASIO_LIBNS::detail::base_from_cancellation_state<Handler>(handler),
  ...
  io_op(const io_op& other)
    : ASIO_LIBNS::detail::base_from_cancellation_state<Handler>(other),
  ...
  io_op(io_op&& other)
    : ASIO_LIBNS::detail::base_from_cancellation_state<Handler>(
        ASIO_MOVE_CAST(
          ASIO_LIBNS::detail::base_from_cancellation_state<Handler>)(
            other)),
      next_layer_(other.next_layer_),
      ...
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.expiry(core_.pending_read_) == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                ASIO_LIBNS::buffer(core_.input_buffer_),
        ...
        case engine::want_output:
          ...
          if (core_.expiry(core_.pending_write_) == core_.neg_infin())
          {
            ...
            ASIO_LIBNS::async_write(next_layer_,
        ...
        default:
          ...
          if (start)
          {
            ...
            next_layer_.async_read_some(
                ASIO_LIBNS::buffer(core_.input_buffer_, 0),
                ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          core_.input_ = ASIO_LIBNS::buffer(
          ...
          {
            ec_ = ASIO_LIBNS::error::operation_aborted;
            break;
          }
