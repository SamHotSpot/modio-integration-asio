 ...
 * @code
 * ASIO_LIBNS::io_context my_context;
 * ASIO_LIBNS::ssl::context ctx(ASIO_LIBNS::ssl::context::sslv23);
 * ASIO_LIBNS::ssl::stream<asio:ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  void set_verify_callback(VerifyCallback callback)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "set_verify_callback");
  }
  ...
  void handshake(handshake_type type)
  {
    ASIO_LIBNS::error_code ec;
    handshake(type, ec);
    ASIO_LIBNS::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  ASIO_SYNC_OP_VOID shutdown(ASIO_LIBNS::error_code& ec)
  {
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      ASIO_LIBNS::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
        ...
        handshake_type type, const ConstBufferSequence& buffers) const
    {
      ...
      ASIO_LIBNS::detail::non_const_lvalue<
  ...
  public:
    ...
    void operator()(ASIO_MOVE_ARG(ShutdownHandler) handler) const
    {
      ...
      ASIO_LIBNS::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      ASIO_LIBNS::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      ASIO_LIBNS::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
