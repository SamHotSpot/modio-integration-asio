  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    ASIO_LIBNS::detail::throw_error(
        ASIO_LIBNS::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    ASIO_LIBNS::error_code ec = translate_error(::ERR_get_error());
    ASIO_LIBNS::detail::throw_error(ec, "context");
  }
...
void context::clear_options(context::options o)
{
  ...
  clear_options(o, ec);
  ASIO_LIBNS::detail::throw_error(ec, "clear_options");
}

ASIO_SYNC_OP_VOID context::clear_options(
    context::options o, ASIO_LIBNS::error_code& ec)
{
...
void context::set_options(context::options o)
{
  ASIO_LIBNS::error_code ec;
  set_options(o, ec);
  ASIO_LIBNS::detail::throw_error(ec, "set_options");
}
    ...
    context::options o, ASIO_LIBNS::error_code& ec)
{
  ...
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      ASIO_LIBNS::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "set_verify_mode");
}

ASIO_SYNC_OP_VOID context::set_verify_mode(
    verify_mode v, ASIO_LIBNS::error_code& ec)
{
...
void context::set_verify_depth(int depth)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "set_verify_depth");
}

ASIO_SYNC_OP_VOID context::set_verify_depth(
    int depth, ASIO_LIBNS::error_code& ec)
{
...
void context::load_verify_file(const std::string& filename)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "load_verify_file");
}

ASIO_SYNC_OP_VOID context::load_verify_file(
    const std::string& filename, ASIO_LIBNS::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "add_certificate_authority");
}

ASIO_SYNC_OP_VOID context::add_certificate_authority(
    const const_buffer& ca, ASIO_LIBNS::error_code& ec)
{
  ::ERR_clear_error();
...
void context::set_default_verify_paths()
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "set_default_verify_paths");
}
...
void context::add_verify_path(const std::string& path)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "add_verify_path");
}

ASIO_SYNC_OP_VOID context::add_verify_path(
    const std::string& path, ASIO_LIBNS::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_certificate");
}
    ...
    const std::string& filename, file_format format)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_certificate_file");
}
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_certificate_chain");
}

ASIO_SYNC_OP_VOID context::use_certificate_chain(
    const const_buffer& chain, ASIO_LIBNS::error_code& ec)
{
  ::ERR_clear_error();
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_certificate_chain_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_private_key");
}
    ...
    const std::string& filename, context::file_format format)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_rsa_private_key");
}
    ...
    const std::string& filename, context::file_format format)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_rsa_private_key_file");
}
...
void context::use_tmp_dh(const const_buffer& dh)
{
  ASIO_LIBNS::error_code ec;
  use_tmp_dh(dh, ec);
  ASIO_LIBNS::detail::throw_error(ec, "use_tmp_dh");
}

ASIO_SYNC_OP_VOID context::use_tmp_dh(
    const const_buffer& dh, ASIO_LIBNS::error_code& ec)
{
  ::ERR_clear_error();
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  ASIO_LIBNS::detail::throw_error(ec, "use_tmp_dh_file");
}
...
ASIO_SYNC_OP_VOID context::do_use_tmp_dh(
    BIO* bio, ASIO_LIBNS::error_code& ec)
{
  ::ERR_clear_error();
...
ASIO_SYNC_OP_VOID context::do_set_verify_callback(
    detail::verify_callback_base* callback, ASIO_LIBNS::error_code& ec)
{
  if (SSL_CTX_get_app_data(handle_))
  {
...
ASIO_SYNC_OP_VOID context::do_set_password_callback(
    detail::password_callback_base* callback, ASIO_LIBNS::error_code& ec)
{
#if ((OPENSSL_VERSION_NUMBER >= 0x10100000L) \
      && (!defined(LIBRESSL_VERSION_NUMBER) \
        || LIBRESSL_VERSION_NUMBER >= 0x2070000fL)) \
...
ASIO_LIBNS::error_code context::translate_error(long error)
{
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
  ...
  return ASIO_LIBNS::error_code(static_cast<int>(error),
      ASIO_LIBNS::error::get_ssl_category());
}
