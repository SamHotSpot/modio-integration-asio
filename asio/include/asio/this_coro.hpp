...
/**
 * @par Example
 * @code ASIO_LIBNS::awaitable<void> my_coroutine()
 * {
 *   ASIO_LIBNS::cancellation_state cs
 *     = co_await ASIO_LIBNS::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != ASIO_LIBNS::cancellation_type::none)
 *     // ...
 * } @endcode
 */
#if defined(ASIO_HAS_CONSTEXPR) || defined(GENERATING_DOCUMENTATION)
 ...
 * ASIO_LIBNS::cancellation_state object <tt>S</tt>, constructed as
 * <tt>S(P)</tt>, into the current coroutine's cancellation state object.
 *
 * @par Example
 * @code ASIO_LIBNS::awaitable<void> my_coroutine()
 * {
 *   co_await ASIO_LIBNS::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using ASIO_LIBNS::co_spawn.
 */
 ...
 * Let <tt>P</tt> be the cancellation slot associated with the current
 * coroutine's @ref co_spawn completion handler. Assigns a new
 * ASIO_LIBNS::cancellation_state object <tt>S</tt>, constructed as <tt>S(P,
 ...
 * {
 *   co_await ASIO_LIBNS::this_coro::reset_cancellation_state(
 *       ASIO_LIBNS::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 *   co_await ASIO_LIBNS::this_coro::reset_cancellation_state(
 *       ASIO_LIBNS::enable_partial_cancellation(),
 *       ASIO_LIBNS::disable_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code ASIO_LIBNS::awaitable<void> my_coroutine()
 * {
 *   if (co_await ASIO_LIBNS::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code ASIO_LIBNS::awaitable<void> my_coroutine()
 * {
 *   co_await ASIO_LIBNS::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */
