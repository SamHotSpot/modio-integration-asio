 ...
 * execution.
 *
 * @param a The ASIO_LIBNS::awaitable object that is the result of calling the
 ...
 * @par Example
 * @code
 * ASIO_LIBNS::awaitable<std::size_t> echo(tcp::socket socket)
 * {
 ...
 *           ASIO_LIBNS::buffer(data), ASIO_LIBNS::use_awaitable);
 *
 *       co_await ASIO_LIBNS::async_write(socket,
 *           ASIO_LIBNS::buffer(data, n), ASIO_LIBNS::use_awaitable);
 *
 *       bytes_transferred += n;
 *     }
 *   }
 ...
 * // ...
 *
 * ASIO_LIBNS::co_spawn(my_executor,
 ...
 * cancellation state, call ASIO_LIBNS::this_coro::reset_cancellation_state.
 */
 ...
 * @par Example
 * @code
 * ASIO_LIBNS::awaitable<void> echo(tcp::socket socket)
 * {
 *   try
 *   {
 *     char data[1024];
 ...
 * // ...
 *
 * ASIO_LIBNS::co_spawn(my_io_context,
 *   echo(std::move(my_tcp_socket)),
 *   [](std::exception_ptr e, std::size_t n)
 *   {
 *     std::cout << "transferred " << n << "\n";
 ...
 * @c ASIO_LIBNS::awaitable<R,E> that will be used as the coroutine's entry
 * point.
 *
 ...
 * @code ASIO_LIBNS::awaitable<R, AwaitableExecutor> F() @endcode
 *
 * @par Example
 * @code
 * ASIO_LIBNS::awaitable<std::size_t> echo(tcp::socket socket)
