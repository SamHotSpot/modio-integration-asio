...
public:
  ...
  ASIO_LIBNS::detail::socket_addr_type* data()
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const ASIO_LIBNS::detail::socket_addr_type* data() const
  {
    return &data_.base;
  }
  ...
  {
    return sizeof(ASIO_LIBNS::detail::sockaddr_un_type);
  }
...
private:
  ...
  union data_union
  {
    ...
    ASIO_LIBNS::detail::sockaddr_un_type local;
  } data_;
