...
public:
   ...
   * Setting the option:
   * @code
   * ASIO_LIBNS::ip::udp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::broadcast option(true);
   ...
   * ASIO_LIBNS::ip::udp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::broadcast option;
...
#else
  typedef ASIO_LIBNS::detail::socket_option::boolean<
   ...
   * ...
   * ASIO_LIBNS::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ASIO_LIBNS::ip::udp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::udp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef ASIO_LIBNS::detail::socket_option::integer<
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * ASIO_LIBNS::socket_base::reuse_address option(true);
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::socket_base::reuse_address option;
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef ASIO_LIBNS::detail::socket_option::linger<
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with ASIO_LIBNS::error::connection_aborted.
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * ASIO_LIBNS::ip::tcp::acceptor acceptor(my_context);
   * ...
   * ASIO_LIBNS::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
...
#else
  typedef ASIO_LIBNS::detail::socket_option::boolean<
    ASIO_LIBNS::detail::custom_socket_option_level,
    ASIO_LIBNS::detail::enable_connection_aborted_option>
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::socket_base::bytes_readable command(true);
...
#else
  typedef ASIO_LIBNS::detail::io_control::bytes_readable bytes_readable;
#endif
