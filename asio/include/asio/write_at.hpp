...
/**
 * @defgroup write_at ASIO_LIBNS::write_at
 *
 ...
 * @code ASIO_LIBNS::write_at(d, 42, ASIO_LIBNS::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code ASIO_LIBNS::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::write_at(d, 42, ASIO_LIBNS::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at ASIO_LIBNS::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * ASIO_LIBNS::async_write_at(d, 42, ASIO_LIBNS::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::async_write_at(d, 42,
