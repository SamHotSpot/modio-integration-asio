...
# if defined(ASIO_HAS_SOURCE_LOCATION)
      ASIO_LIBNS::detail::source_location location =
        ASIO_LIBNS::detail::source_location::current()
...
/// resumable coroutine.
/**
 * See the documentation for ASIO_LIBNS::use_coro_t for a usage example.
 */
