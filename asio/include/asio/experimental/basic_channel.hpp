...
private:
  ...
  typedef detail::channel_service<ASIO_LIBNS::detail::null_mutex> service_type;
...
public:
  ...
  basic_channel(const executor_type& ex, std::size_t max_buffer_size = 0)
    : service_(&ASIO_LIBNS::use_service<service_type>(
  ...
  basic_channel(ExecutionContext& context, std::size_t max_buffer_size = 0,
    ...
    : service_(&ASIO_LIBNS::use_service<service_type>(context)),
      impl_(),
   ...
   * @c ASIO_LIBNS::experimental::error::channel_cancelled. Outstanding receive
...
private:
  ...
  {
    return ASIO_LIBNS::query(t, execution::context);
  }
  ...
  public:
    ...
    {
      ASIO_LIBNS::detail::non_const_lvalue<SendHandler> handler2(handler);
  ...
  public:
    ...
    {
      ASIO_LIBNS::detail::non_const_lvalue<ReceiveHandler> handler2(handler);
