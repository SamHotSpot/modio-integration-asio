...
struct partial_promise
{
  ...
  {
    return ASIO_LIBNS::detail::suspend_always{};
  }
  ...
  auto final_suspend() noexcept
  {
    struct awaitable_t
    {
      ...
      auto await_suspend(ASIO_LIBNS::detail::coroutine_handle<>) noexcept
      {
...
struct coroutine_traits<
    coroutine_handle<ASIO_LIBNS::experimental::detail::partial_promise>,
    Args...>
{
  using promise_type = ASIO_LIBNS::experimental::detail::partial_promise;
};
