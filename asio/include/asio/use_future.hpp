 ...
 * operation, typically using the special value @c ASIO_LIBNS::use_future. For
 * example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, ASIO_LIBNS::use_future); @endcode
 *
...
public:
   ...
   *     use_future([](ASIO_LIBNS::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
...
/// return a future.
/**
 * See the documentation for ASIO_LIBNS::use_future_t for a usage example.
 */
