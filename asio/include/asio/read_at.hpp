...
/**
 * @defgroup read_at ASIO_LIBNS::read_at
 *
 ...
 * @code ASIO_LIBNS::read_at(d, 42, ASIO_LIBNS::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code ASIO_LIBNS::read_at(
 *     d, 42, buffers,
 *     ASIO_LIBNS::transfer_all()); @endcode
 */
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::read_at(d, 42,
 *     ASIO_LIBNS::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @code ASIO_LIBNS::read_at(
 *     d, 42, buffers,
 *     ASIO_LIBNS::transfer_all(), ec); @endcode
 */
template <typename SyncRandomAccessReadDevice, typename MutableBufferSequence>
std::size_t read_at(SyncRandomAccessReadDevice& d,
    uint64_t offset, const MutableBufferSequence& buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::read_at(d, 42, ASIO_LIBNS::buffer(data, size),
 *     ASIO_LIBNS::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 */
...
/*@}*/
/**
 * @defgroup async_read_at ASIO_LIBNS::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * ASIO_LIBNS::async_read_at(d, 42, ASIO_LIBNS::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code ASIO_LIBNS::async_read_at(
 *     d, 42, buffers,
 *     ASIO_LIBNS::transfer_all(),
 *     handler); @endcode
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::async_read_at(d, 42,
 *     ASIO_LIBNS::buffer(data, size),
 *     ASIO_LIBNS::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
