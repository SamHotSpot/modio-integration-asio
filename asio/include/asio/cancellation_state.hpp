...
public:
   ...
   * @code ASIO_LIBNS::cancellation_type_t filter(
   *     ASIO_LIBNS::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li ASIO_LIBNS::disable_cancellation
   * @li ASIO_LIBNS::enable_terminal_cancellation
   * @li ASIO_LIBNS::enable_partial_cancellation
   * @li ASIO_LIBNS::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code ASIO_LIBNS::cancellation_type_t in_filter(
   *     ASIO_LIBNS::cancellation_type_t); @endcode
   *
   ...
   * @code ASIO_LIBNS::cancellation_type_t out_filter(
   *     ASIO_LIBNS::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
