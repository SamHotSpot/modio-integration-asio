 ...
 * expression <tt>ASIO_LIBNS::require_concept(E, P)</tt> for some
 ...
 *   with value <tt>true</tt>, <tt>ASIO_LIBNS::require_concept(E, P)</tt> is
 *   ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>ASIO_LIBNS::require_concept(E, P)</tt> is ill-formed.
 */
 ...
 * <tt>ASIO_LIBNS::require_concept(std::declval<T>(),
...
using ASIO_LIBNS::traits::require_concept_free;
using ASIO_LIBNS::traits::require_concept_member;
using ASIO_LIBNS::traits::static_require_concept;
