...
public:
   ...
   * ASIO_LIBNS::posix::descriptor_base::bytes_readable @n
   * ASIO_LIBNS::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * ASIO_LIBNS::posix::stream_descriptor descriptor(my_context);
   * ...
   * ASIO_LIBNS::posix::stream_descriptor::bytes_readable command;
   ...
   * ASIO_LIBNS::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(ASIO_LIBNS::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * descriptor.wait(ASIO_LIBNS::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     ASIO_LIBNS::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   *
