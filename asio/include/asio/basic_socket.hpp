...
public:
    ...
    : impl_(0, ex)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "open");
  }
    ...
    : impl_(0, ex)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "bind");
  }
   ...
   * @par Example
   * @code
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * socket.open(ASIO_LIBNS::ip::tcp::v4());
   * @endcode
   */
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ASIO_LIBNS::error_code ec;
   * socket.open(ASIO_LIBNS::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  ASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_socket, ASIO_LIBNS::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_socket, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * with the ASIO_LIBNS::error::operation_aborted error.
   *
   * @throws ASIO_LIBNS::system_error Thrown on failure. Note that, even if
   ...
   * will be passed the ASIO_LIBNS::error::operation_aborted error. Ownership
   ...
   * This function causes all outstanding asynchronous connect, send and receive
   * operations to finish immediately, and the handlers for cancelled operations
   * will be passed the ASIO_LIBNS::error::operation_aborted error.
   *
   * @throws ASIO_LIBNS::system_error Thrown on failure.
   *
   * @note Calls to cancel() will always fail with
   * ASIO_LIBNS::error::operation_not_supported when run on Windows XP, Windows
  ...
  bool at_mark() const
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "at_mark");
    return b;
  }
   ...
   * mark.
   */
  bool at_mark(ASIO_LIBNS::error_code& ec) const
  {
  ...
  std::size_t available() const
  {
    ...
    std::size_t s = impl_.get_service().available(
        impl_.get_implementation(), ec);
    ASIO_LIBNS::detail::throw_error(ec, "available");
    return s;
  }
   ...
   * error occurs.
   */
  std::size_t available(ASIO_LIBNS::error_code& ec) const
  {
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * socket.open(ASIO_LIBNS::ip::tcp::v4());
   * socket.bind(ASIO_LIBNS::ip::tcp::endpoint(
   *       ASIO_LIBNS::ip::tcp::v4(), 12345));
   * @endcode
   */
   ...
   * @code
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ASIO_LIBNS::ip::tcp::endpoint endpoint(
   *     ASIO_LIBNS::ip::address::from_string("1.2.3.4"), 12345);
  ...
  void connect(const endpoint_type& peer_endpoint)
  {
    ...
    if (!is_open())
    {
      ...
      ASIO_LIBNS::detail::throw_error(ec, "connect");
    }
   ...
   * @par Example
   * @code
   * void connect_handler(const ASIO_LIBNS::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Connect succeeded.
   ...
   * cancellation for the following ASIO_LIBNS::cancellation_type values:
   *
  ...
  async_connect(const endpoint_type& peer_endpoint,
    ...
    ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX((
      async_initiate<ConnectToken, void (ASIO_LIBNS::error_code)>(
          declval<initiate_async_connect>(), token,
          peer_endpoint, declval<ASIO_LIBNS::error_code&>())))
  {
    ASIO_LIBNS::error_code open_ec;
    if (!is_open())
    {
    ...
    return async_initiate<ConnectToken, void (ASIO_LIBNS::error_code)>(
   ...
   * ASIO_LIBNS::socket_base::broadcast @n
   * ASIO_LIBNS::socket_base::do_not_route @n
   * ASIO_LIBNS::socket_base::keep_alive @n
   * ASIO_LIBNS::socket_base::linger @n
   * ASIO_LIBNS::socket_base::receive_buffer_size @n
   * ASIO_LIBNS::socket_base::receive_low_watermark @n
   * ASIO_LIBNS::socket_base::reuse_address @n
   * ASIO_LIBNS::socket_base::send_buffer_size @n
   * ASIO_LIBNS::socket_base::send_low_watermark @n
   * ASIO_LIBNS::ip::multicast::join_group @n
   * ASIO_LIBNS::ip::multicast::leave_group @n
   * ASIO_LIBNS::ip::multicast::enable_loopback @n
   * ASIO_LIBNS::ip::multicast::outbound_interface @n
   * ASIO_LIBNS::ip::multicast::hops @n
   * ASIO_LIBNS::ip::tcp::no_delay
   *
   * @par Example
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::no_delay option(true);
  ...
  void set_option(const SettableSocketOption& option)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "set_option");
  }
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::socket::keep_alive option;
  ...
  void get_option(GettableSocketOption& option) const
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "get_option");
  }
   ...
   * ASIO_LIBNS::socket_base::bytes_readable @n
   * ASIO_LIBNS::socket_base::non_blocking_io
   *
   * @par Example
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::socket::bytes_readable command;
  ...
  void io_control(IoControlCommand& command)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "io_control");
  }
   ...
   * ASIO_LIBNS::error::would_block if they are unable to perform the requested
   * operation immediately. If @c false, synchronous operations will block
   * until complete.
   *
   * @note The non-blocking mode has no effect on the behaviour of asynchronous
   * operations. Asynchronous operations will never fail with the error
   * ASIO_LIBNS::error::would_block.
   */
  ...
  void non_blocking(bool mode)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "non_blocking");
  }
  ...
  ASIO_SYNC_OP_VOID non_blocking(
      bool mode, ASIO_LIBNS::error_code& ec)
  {
    impl_.get_service().non_blocking(impl_.get_implementation(), mode, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * direct system calls may fail with ASIO_LIBNS::error::would_block (or the
   ...
   *   void operator()(ASIO_LIBNS::error_code ec, std::size_t)
   *   {
   ...
   *         ec = ASIO_LIBNS::error_code(n < 0 ? errno : 0,
   *             ASIO_LIBNS::error::get_system_category());
   *         total_bytes_transferred_ += ec ? 0 : n;
   *
   *         // Retry operation immediately if interrupted by signal.
   *         if (ec == ASIO_LIBNS::error::interrupted)
   *           continue;
   *
   *         // Check if we need to run the operation again.
   *         if (ec == ASIO_LIBNS::error::would_block
   *             || ec == ASIO_LIBNS::error::try_again)
   *         {
   ...
   * mode and direct system calls may fail with ASIO_LIBNS::error::would_block
   * (or the equivalent system error).
   *
   * @throws ASIO_LIBNS::system_error Thrown on failure. If the @c mode is
   * @c false, but the current value of @c non_blocking() is @c true, this
   * function fails with ASIO_LIBNS::error::invalid_argument, as the
  ...
  void native_non_blocking(bool mode)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "native_non_blocking");
  }
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::endpoint endpoint = socket.local_endpoint();
   * @endcode
   */
  endpoint_type local_endpoint() const
  {
    ...
    endpoint_type ep = impl_.get_service().local_endpoint(
        impl_.get_implementation(), ec);
    ASIO_LIBNS::detail::throw_error(ec, "local_endpoint");
    return ep;
  }
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * ASIO_LIBNS::ip::tcp::endpoint endpoint = socket.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  endpoint_type local_endpoint(ASIO_LIBNS::error_code& ec) const
  {
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * ASIO_LIBNS::ip::tcp::endpoint endpoint = socket.remote_endpoint();
   * @endcode
   */
  endpoint_type remote_endpoint() const
  {
    ...
    endpoint_type ep = impl_.get_service().remote_endpoint(
        impl_.get_implementation(), ec);
    ASIO_LIBNS::detail::throw_error(ec, "remote_endpoint");
    return ep;
  }
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * ASIO_LIBNS::ip::tcp::endpoint endpoint = socket.remote_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  endpoint_type remote_endpoint(ASIO_LIBNS::error_code& ec) const
  {
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * socket.shutdown(ASIO_LIBNS::ip::tcp::socket::shutdown_send);
   * @endcode
   */
  void shutdown(shutdown_type what)
  {
    ...
    ASIO_LIBNS::detail::throw_error(ec, "shutdown");
  }
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * socket.shutdown(ASIO_LIBNS::ip::tcp::socket::shutdown_send, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * socket.wait(ASIO_LIBNS::ip::tcp::socket::wait_read);
   * @endcode
   */
   ...
   * ...
   * ASIO_LIBNS::error_code ec;
   * socket.wait(ASIO_LIBNS::ip::tcp::socket::wait_read, ec);
   * @endcode
   */
  ASIO_SYNC_OP_VOID wait(wait_type w, ASIO_LIBNS::error_code& ec)
  {
    impl_.get_service().wait(impl_.get_implementation(), w, ec);
    ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * @par Example
   * @code
   * void wait_handler(const ASIO_LIBNS::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Wait succeeded.
   ...
   * ASIO_LIBNS::ip::tcp::socket socket(my_context);
   * ...
   * socket.async_wait(ASIO_LIBNS::ip::tcp::socket::wait_read, wait_handler);
   * @endcode
   *
   * @par Per-Operation Cancellation
   * On POSIX or Windows operating systems, this asynchronous operation supports
...
private:
  ...
  public:
    ...
    void operator()(ASIO_MOVE_ARG(ConnectHandler) handler,
        ...
        const ASIO_LIBNS::error_code& open_ec) const
    {
      ...
      if (open_ec)
      {
          ASIO_LIBNS::post(self_->impl_.get_executor(),
              ASIO_LIBNS::detail::bind_handler(
