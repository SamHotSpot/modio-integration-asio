 ...
 * @c ASIO_LIBNS::detached. For example:
 *
 * @code my_socket.async_send(my_buffer, ASIO_LIBNS::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for ASIO_LIBNS::detached_t for a usage example.
 */
