 ...
 * @code ASIO_LIBNS::read(s, ASIO_LIBNS::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code ASIO_LIBNS::read(
 *     s, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::read(s, ASIO_LIBNS::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code ASIO_LIBNS::read(s, ASIO_LIBNS::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read ASIO_LIBNS::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * ASIO_LIBNS::async_read(s, ASIO_LIBNS::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
