 ...
 *
 * To submit functions to the thread pool, use the @ref ASIO_LIBNS::dispatch,
 ...
 * ASIO_LIBNS::thread_pool pool(4);
 *
 * // Submit a function to the pool.
 * ASIO_LIBNS::post(pool, my_task);
 *
 * // Submit a lambda object to the pool.
 * ASIO_LIBNS::post(pool,
 *     []()
 *     {
 *       ...
 *     });
...
private:
   ...
   * @code auto ex1 = my_thread_pool.executor();
   * auto ex2 = ASIO_LIBNS::require(ex1,
   *     ASIO_LIBNS::execution::blocking.always); @endcode
   */
  ASIO_CONSTEXPR basic_executor_type<Allocator,
...
private:
   ...
   * if (ASIO_LIBNS::query(ex, ASIO_LIBNS::execution::bulk_guarantee)
   *       == ASIO_LIBNS::execution::bulk_guarantee.parallel)
   *   ... @endcode
   */
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * ASIO_LIBNS::thread_pool& pool = ASIO_LIBNS::query(
   ...
   * For example:
   * @code auto ex = my_thread_pool.executor();
   * std::size_t occupancy = ASIO_LIBNS::query(
   *     ex, ASIO_LIBNS::execution::occupancy); @endcode
   */
...
struct equality_comparable<
    ASIO_LIBNS::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
...
struct schedule_member<
    const ASIO_LIBNS::thread_pool::basic_executor_type<Allocator, Bits>
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::thread_pool::basic_executor_type<
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::execution::detail::as_operation<
      ASIO_LIBNS::thread_pool::basic_executor_type<Allocator, Bits>,
...
struct require_member<
  ...
  > : ASIO_LIBNS::detail::thread_pool_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::thread_pool::basic_executor_type<
...
struct require_member<
    ASIO_LIBNS::thread_pool::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::blocking_t::always_t
  > : ASIO_LIBNS::detail::thread_pool_bits
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = false);
  typedef ASIO_LIBNS::thread_pool::basic_executor_type<Allocator,
...
struct query_static_constexpr_member<
    ...
    typename ASIO_LIBNS::enable_if<
      ASIO_LIBNS::is_convertible<
        Property,
        ASIO_LIBNS::execution::bulk_guarantee_t
      >::value
    >::type
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::execution::bulk_guarantee_t::parallel_t result_type;
...
struct query_member<
    ASIO_LIBNS::thread_pool::basic_executor_type<Allocator, Bits>,
    ASIO_LIBNS::execution::occupancy_t
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  ...
  >
{
  ASIO_STATIC_CONSTEXPR(bool, is_valid = true);
  ASIO_STATIC_CONSTEXPR(bool, is_noexcept = true);
  typedef ASIO_LIBNS::thread_pool& result_type;
};
