 ...
 *
 * Most applications will use the ASIO_LIBNS::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * ASIO_LIBNS::deadline_timer timer(my_context);
 *
 ...
 * @endcode
 *
 * @li The ASIO_LIBNS::basic_deadline_timer::expires_from_now() function
...
template <typename Time,
    typename TimeTraits = ASIO_LIBNS::time_traits<Time>,
