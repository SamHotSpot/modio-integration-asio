...
struct is_match_condition
{
  ...
  enum
  {
    value = ASIO_LIBNS::is_function<
        typename ASIO_LIBNS::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until ASIO_LIBNS::read_until
 *
 ...
 * std::size_t n = ASIO_LIBNS::read_until(s,
 *     ASIO_LIBNS::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, ASIO_LIBNS::error_code& ec,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
 ...
 * @code std::string data;
 * std::size_t n = ASIO_LIBNS::read_until(s,
 *     ASIO_LIBNS::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    const boost::regex& expr, ASIO_LIBNS::error_code& ec,
    typename constraint<
      is_dynamic_buffer_v1<typename decay<DynamicBuffer_v1>::type>::value
    >::type = 0,
    typename constraint<
 ...
 * @code typedef ASIO_LIBNS::buffers_iterator<
 *     ASIO_LIBNS::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * ASIO_LIBNS::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * ASIO_LIBNS::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    ASIO_MOVE_ARG(DynamicBuffer_v1) buffers,
    MatchCondition match_condition, ASIO_LIBNS::error_code& ec,
    typename constraint<
      is_match_condition<MatchCondition>::value
    >::type = 0,
    typename constraint<
 ...
 * @code ASIO_LIBNS::streambuf b;
 * ASIO_LIBNS::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    ASIO_LIBNS::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    ASIO_LIBNS::basic_streambuf<Allocator>& b,
    ASIO_STRING_VIEW_PARAM delim);
...
std::size_t read_until(SyncReadStream& s,
    ASIO_LIBNS::basic_streambuf<Allocator>& b,
    ASIO_STRING_VIEW_PARAM delim, ASIO_LIBNS::error_code& ec);
 ...
 * @code ASIO_LIBNS::streambuf b;
 * ASIO_LIBNS::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    ASIO_LIBNS::basic_streambuf<Allocator>& b, const boost::regex& expr);
 ...
 * @code typedef ASIO_LIBNS::buffers_iterator<
 *     ASIO_LIBNS::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * }
 * ...
 * ASIO_LIBNS::streambuf b;
 * ASIO_LIBNS::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * ASIO_LIBNS::streambuf b;
 * ASIO_LIBNS::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    ASIO_LIBNS::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
/*@}*/
/**
 * @defgroup async_read_until ASIO_LIBNS::async_read_until
 *
 ...
 * @code void(ASIO_LIBNS::error_code, std::size_t) @endcode
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const ASIO_LIBNS::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * }
 * ...
 * ASIO_LIBNS::async_read_until(s, data, '\n', handler); @endcode
 ...
 * ASIO_LIBNS::cancellation_type values:
 *
 ...
 * ...
 * std::string data;
 * ASIO_LIBNS::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * ASIO_LIBNS::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 * }
 * ...
 * ASIO_LIBNS::async_read_until(s, b, '\n', handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * }
 * ...
 * ASIO_LIBNS::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * ASIO_LIBNS::streambuf b;
 * ASIO_LIBNS::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * ASIO_LIBNS::streambuf b;
 * ASIO_LIBNS::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
